...
The PHP language has the `mail` function to directly send mails but we do not support it because of all the maintenance it needs.
Instead, we recommend you to use [Mailgun](https://www.mailgun.com/) or [Mailjet](https://www.mailjet.com/). These services already have
everything you need to send emails from your code.
