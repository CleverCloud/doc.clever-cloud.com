...
**Note**: if your project uses webpacker, make sure to enable vertical scaling if your instance is smaller than M because it needs a lot a ressources when starting.
