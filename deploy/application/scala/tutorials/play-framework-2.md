---
title: Deploy Play Framework 2 Scala
position: 2
...
Play! 2 applications use sbt. Please have a look at [deploy scala apps]({{< ref "/deploy/application/scala/scala" >}}) for a complete documentation on sbt deployment options.
