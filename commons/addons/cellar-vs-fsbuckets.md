...
Every time you redeploy your application, you lose the old VMs and all the files stored on their filesystem.
...
Clients exists for a lot of languages.
...
You can manage ACLs, generate signed URLs with an expiration date.

### Upsides

You can move the file uploads to your client entirely.
Just give it a temporary signed URL and upload directly from the client to Cellar.
...
You can delegate the authorization part to Cellar by giving signed urls for file download
and uploads.
