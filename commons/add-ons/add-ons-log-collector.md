...
Note that, for the same reasons as the one mentioned in [Add-on API](/add-ons/add-ons-api) article, which you should have read if your reading these lines, if you already are a Heroku add-on provider, you should not be lost using this log collector API.
