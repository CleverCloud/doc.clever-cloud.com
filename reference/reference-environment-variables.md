...
|[NEW_RELIC_LICENSE](https://docs.newrelic.com/docs/apm/agents/java-agent/configuration/java-agent-configuration-config-file/#ev-NEW_RELIC_LICENSE_KEY) | Contains the application name |  |  |
{{< /table >}}
